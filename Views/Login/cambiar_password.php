    ...
    <section class="login-content">
      ...
      <div class="login-box flipped">
        ...
        <form id="formCambiarPass" name="formCambiarPass" class="forget-form" action="">
          ...
          <h3 class="login-head"><i class="fas fa-key"></i> Cambiar contraseè´–a</h3>
          <div class="form-group">
            <input id="txtPassword" name="txtPassword" class="form-control" type="password" placeholder="Nueva contraseè´–a" required >
          </div>
          <div class="form-group">
            <input id="txtPasswordConfirm" name="txtPasswordConfirm" class="form-control" type="password" placeholder="Confirmar contraseè´–a" required >
          </div>
